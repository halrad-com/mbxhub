...
| [`hello-spout/`](hello-spout/) | C++ / CMake | **Video.** Sends a Spout stream and receives one back through `mbxspout.dll`. Two instances are a complete demo with no third-party application in it. Needs the **mbxspout** repo checked out beside this one. |
